package cn.jk.study.spring3;

import cn.jk.study.spring3.bean.User;
...
public class Index {
    public static void main(String... args) {
        ...
        ApplicationContext context = new ClassPathXmlApplicationContext("cn/jk/study/spring3/beans3.xml");
